 ...
 * @version 1.0
 */
public final class P6eModelConfig implements Serializable {
    /** 参数异常 */
    public static final String ERROR_PARAM_EXCEPTION = "400-ERROR_PARAM_EXCEPTION";

    /** 参数异常 */
    public static final String ERROR_OAUTH2_PARAM_EXCEPTION = "ERROR_OAUTH2_PARAM_EXCEPTION";
    /** 服务器内部出现异常 */
    public static final String ERROR_OAUTH2_SERVICE_INSIDE = "500-ERROR_OAUTH2_SERVICE_INSIDE";
