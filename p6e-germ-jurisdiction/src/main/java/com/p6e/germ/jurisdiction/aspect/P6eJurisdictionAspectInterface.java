...
public interface P6eJurisdictionAspectInterface<T extends P6eJurisdictionAspectModel> {
     ...
     */
    public T execute(final P6eHttpServlet p6eHttpServlet, final Object[] args) throws Throwable;
     ...
     */
    public default Object error(final P6eHttpServlet p6eHttpServlet) throws Throwable {
        ...
        if (httpServletResponse != null) {
            ...
            printWriter.write("{\"code\":401,\"message\":\"ERROR_NO_JURISDICTION\"}");
            printWriter.flush();
            printWriter.close();
        }
        return null;
