...
//import com.p6e.germ.oauth2.cache.IP6eCacheAuth2;
...
//     */
//    @Resource
//    private IP6eCacheAuth2 p6eCacheAuth;
//
//    @Resource
...
//                if (bool) {
//                    // 生产随机 mark
//                    final String mark = P6eCommonUtil.generateUuid();
//                    p6eCacheAuth.setCodeMark(mark, P6eJsonUtil.toJson(p6eClientResultDto));
...
//                        P6eJsonUtil.fromJson(content, new TypeToken<Map<String, Object>>(){}.getType());
...
//                        }
//                    }
//                    final String codeVoucher = P6eCommonUtil.generateUuid();
//                    p6eCacheAuth.setCodeVoucher(codeVoucher, P6eJsonUtil.toJson(map));
...
//            p6eAuthCollateCodeResultDto.setData(P6eJsonUtil.fromJson(content, new TypeToken<Map<String, String>>(){}.getType()));
//        } catch (Exception e) {
//            e.printStackTrace();
//        } finally {
...
//                    // 生产随机 mark
//                    final String mark = P6eCommonUtil.generateUuid();
//                    p6eCacheAuth.setTokenMark(mark, P6eJsonUtil.toJson(p6eClientResultDto));
